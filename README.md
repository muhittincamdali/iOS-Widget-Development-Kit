...
<!-- TOC START -->
## Table of Contents
- [📱 iOS Widget Development Kit](#-ios-widget-development-kit)
...
- [📱 Widget Types](#-widget-types)
  ...
  - [Lock Screen Widget](#lock-screen-widget)
- [🎨 Customization](#-customization)
  - [Widget Styling](#widget-styling)
  - [Dynamic Theming](#dynamic-theming)
- [⚡ Live Activities](#-live-activities)
  - [Live Activity Creation](#live-activity-creation)
  - [Dynamic Island Integration](#dynamic-island-integration)
- [🔗 Data Integration](#-data-integration)
  - [Widget Data Manager](#widget-data-manager)
